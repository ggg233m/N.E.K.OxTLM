        ...
        "properties": {
            ...
            "args": {
                ...
                "description": (
                    ...
                    "纯矿石 selector 附近无目标时默认有界 auto 探矿；显式 mode=nearby 可关闭。玩家明确要求"
                    "向前、向下或指定预算探矿时传 mining_plan：{mode:nearby|forward_tunnel|staircase_down|auto,"
                    ...
                    "staircase_down/auto 默认 max_depth=4，其余默认 0。未传 mining_plan 时，纯矿石"
